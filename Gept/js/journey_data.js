...
window.JOURNEY_TIERS = [
  {
    ...
    desc: "打好第一步！從初級核心 2,385 詞庫中隨機辨析 80 題、建立基本五大句型直覺與生活打招呼習慣用語。",
    stages: [
      {
        id: "t1_s1",
        name: "關卡 1-1：初級核心基礎詞彙 (80 題抽測)",
        mode: "blitz",
        targetGoal: 80,
        unitName: "題單字辨析",
        introTip: "專注於名詞與動詞的直覺反應，打穩前 80 題基礎詞庫！",
        rewardXP: 250
      },
      {
        id: "t1_s2",
  ...
  },
  {
    ...
    desc: "加強時態變化與被動語態！完成 120 題中初級詞彙抽測與發音跟讀啟蒙。",
    stages: [
      {
        id: "t2_s1",
  ...
  },
  {
    ...
    desc: "攻克 220 題中級商務考點字、外商會議高頻片語與 3 回合情境對決！",
    stages: [
      {
        id: "t4_s1",
  ...
  },
  {
    ...
    desc: "直指金色證書門檻！300 題高強度詞彙、假設語氣與科技趨勢深度短文。",
    stages: [
      {
        id: "t5_s1",
        name: "關卡 5-1：中高級過渡核心字庫 (300 題)",
        mode: "blitz",
        targetGoal: 300,
        unitName: "題單字辨析",
  ...
  },
  {
    ...
    desc: "攻入 3,300+ 學術詞彙庫 (AWL)！400 題金證字彙、分詞構句與高情商商務談判！",
    stages: [
      {
        id: "t6_s1",
        name: "關卡 6-1：AWL 學術與金證專屬詞庫 (400 題)",
        mode: "blitz",
        targetGoal: 400,
        unitName: "題單字辨析",
  ...
  },
  {
    ...
    desc: "500 題深度詞彙盲測、高階商務慣用語與國際酒會社交破冰全通關！",
    stages: [
      {
        id: "t7_s1",
        name: "關卡 7-1：中高級高階抽象詞彙大閱兵 (500 題)",
        mode: "blitz",
        targetGoal: 500,
        unitName: "題單字辨析",
        introTip: "在高壓隨機抽測下保持 92% 以上精準度！",
        rewardXP: 1800
      },
      {
        id: "t7_s2",
  ...
  },
  {
    ...
    desc: "終極榮耀！從全量 8,365 詞庫盲測 600 題、高契合度母語發音跟讀與全情境大滿貫！",
    stages: [
      {
        id: "t8_s1",
        name: "關卡 8-1：全量 8,365 詞庫極限大亂鬥 (600 題)",
        mode: "blitz",
        targetGoal: 600,
        unitName: "題極限盲測",
      ...
      },
      {
        ...
        targetGoal: 30,
        unitName: "次頂尖跟讀 (85%+)",
        introTip: "發音契合度達 85% 以上，達到母語發音直覺！",
        rewardXP: 3200
      },
      {
        id: "t8_s3",
        ...
        targetGoal: 6,
        unitName: "場完勝對決",
        introTip: "在所有職場、社交與談判對話中取得 10 分滿分評價！",
        rewardXP: 4000
      }
    ]
  }
